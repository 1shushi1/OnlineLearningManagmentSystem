...
namespace BYT_Project
{
    ...
    public class Quiz
    {
        ...
        // one-to-one qualified relation with Question, Question is a qualifier for Quiz 

        private List<Quiz> _relatedQuizzes = new List<Quiz>(); // zero-to-many reflex relation with Quiz
        private Lesson? _lesson; // one-to-one composition relation with Lesson, Lesson composes of Quiz
