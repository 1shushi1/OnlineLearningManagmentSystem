...
namespace BYT_Project
{
    ...
    public class Timetable
    {
        ...
        private List<Course> _courses = new List<Course>(); // one-to-many relation with Course, Course aggregates Timetable
        ...
        public void AddCourse(Course course)
        {
            ...
            // Prevents adding the same course multiple times
        ...
        public void RemoveCourse(Course course)
        {
            ...
            // Ensures the course exists in the timetable's list before removing it
