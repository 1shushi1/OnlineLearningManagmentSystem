...
namespace BYT_Project
{
    ...
    public class Certificate
    {
        ...
        private List<Enrollment> _enrollments = new List<Enrollment>(); // one-to-many relation with Enrollment
        ...
        public void AddEnrollment(Enrollment enrollment)
        {
            ...
            // Ensures the enrollment is not already associated with another certificate
        ...
        public void RemoveEnrollment(Enrollment enrollment)
        {
            ...
            // Ensures the enrollment exists in the `_enrollments` list before attempting to remove it
