...
namespace BYT_Project
{
    ...
    public class Enrollment
    {
        ...
        public static void SaveEnrollments(string path = "enrollments.xml")
        {
            try
            {
        ...
        public static bool LoadEnrollments(string path = "enrollments.xml")
        {
            try
            {
        ...
        public static List<Enrollment> EnrollmentsList => enrollmentsList;
    }
}
